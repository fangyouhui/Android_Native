package com.faceunity.view.seekbar.internal;
...
/**
 * Class to manage the floating bubble thing, similar (but quite worse tested than
...
public class PopupIndicator {
     ...
     * We may/should change this in the future to use just the PARENT View width and/or pass it in the
     * constructor
     */
    ...
    private class Floater extends FrameLayout implements MarkerDrawable.MarkerAnimationListener {
        ...
        public Floater(Context context, AttributeSet attrs, int defStyleAttr, String maxValue,
            ...
            addView(mMarker, new LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT,
