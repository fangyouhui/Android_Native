...
public class AlmostRippleDrawable extends StateDrawable implements Animatable {
    ...
    public void setColor(@NonNull ColorStateList tintStateList) {
        ...
        mFocusedColor = tintStateList.getColorForState(new int[]{android.R.attr.state_enabled,
                android.R.attr.state_focused}, defaultColor);
        mPressedColor = tintStateList.getColorForState(new int[]{android.R.attr.state_enabled,
                android.R.attr.state_pressed}, defaultColor);
        mDisabledColor = tintStateList.getColorForState(new int[]{-android.R.attr.state_enabled},
                defaultColor);
    ...
    private static int getModulatedAlphaColor(int alphaValue, int originalColor) {
        ...
        alpha = alpha * scale >> 8;
        return Color.argb(alpha, Color.red(originalColor), Color.green(originalColor),
