...
public class BeautyPlasticRecyclerAdapter extends RecyclerView.Adapter<BeautyPlasticRecyclerAdapter.BeautyViewHolder> {
    ...
    public BeautyViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(TuSdkContext.getLayoutResId(
                "tusdk_recycler_beauty_item_layout"), null);
    ...
    class BeautyViewHolder extends RecyclerView.ViewHolder {
        ...
        public BeautyViewHolder(View itemView) {
            super(itemView);
            mBeautyLevelText = (TextView) itemView.findViewById(TuSdkContext.getIDResId(
                    "lsq_beauty_level_text"));
            mBeautyLevelImage = (ImageView) itemView.findViewById(TuSdkContext.getIDResId(
                    "lsq_beauty_level_image"));
