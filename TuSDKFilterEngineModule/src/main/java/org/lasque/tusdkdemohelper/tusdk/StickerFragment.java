...
public class StickerFragment extends Fragment {
     ...
     * 贴纸删除事件
     */
    private StickerRecyclerAdapter.ItemDeleteListener mItemDeleteListener =
            new StickerRecyclerAdapter.ItemDeleteListener() {
                @Override
     ...
     * 贴纸点击事件
     */
    private StickerRecyclerAdapter.ItemClickListener mStickerClickListener =
            new StickerRecyclerAdapter.ItemClickListener() {
                @Override
