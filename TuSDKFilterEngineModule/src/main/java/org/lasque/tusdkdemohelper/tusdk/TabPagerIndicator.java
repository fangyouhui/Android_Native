...
public class TabPagerIndicator extends LinearLayout {
    ...
    private void getAttrs(Context context, AttributeSet attributeSet) {
        ...
        mDefaultVisibleCounts = attributes.getInt(R.styleable.TabPagerIndicator_default_display_counts,
        ...
        mHighLightTextColor = attributes.getColor(R.styleable.TabPagerIndicator_high_light_text_color,
                Color.WHITE);
        mLineHeight = attributes.getInt(R.styleable.TabPagerIndicator_line_size, 10);
        mLineWidth = (int) attributes.getDimension(R.styleable.TabPagerIndicator_line_width,
                TuSdkContext.px2dip(getScreenWidth() / mDefaultVisibleCounts));
    ...
    protected void dispatchDraw(Canvas canvas) {
        canvas.save();
        canvas.drawLine(mMoveX + dip2px(10), getHeight(), mMoveX + mLineWidth - dip2px(10), getHeight(),
                mLinePaint);
        canvas.restore();
