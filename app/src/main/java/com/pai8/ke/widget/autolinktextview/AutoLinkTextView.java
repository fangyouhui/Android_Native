package com.pai8.ke.widget.autolinktextview;
...
public class AutoLinkTextView extends AppCompatTextView {
    ...
    public AutoLinkTextView(Context context, AttributeSet attrs) {
        ...
        highLightColor = array.getColor(R.styleable.AutoLinkTextView_highlight_text_color, Color.BLUE);
        defaultSelectedColor = array.getColor(R.styleable.AutoLinkTextView_default_text_color, Color.WHITE);
        setHighLightColor();
    }
