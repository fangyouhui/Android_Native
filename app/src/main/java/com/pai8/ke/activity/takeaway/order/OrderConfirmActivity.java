 ...
 * 外卖订单确认
 */
public class OrderConfirmActivity extends BaseMvpActivity<ConfirmOrderPresenter> implements View.OnClickListener, ConfirmContract.View {
    ...
    public static final int ACTIVITY_CONFIRM_ORDER = R.layout.activity_order_confirm;
    ...
    void showOutDistancePop(String msg) {
        ...
        OrderConfirmActivity.ViewHolder holder = new OrderConfirmActivity.ViewHolder(view);
