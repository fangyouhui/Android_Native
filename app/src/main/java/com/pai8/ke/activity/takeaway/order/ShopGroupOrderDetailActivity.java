...
import com.pai8.ke.databinding.ActivityShopGroupOrderDetailBinding;
...
public class ShopGroupOrderDetailActivity extends BaseActivity<UserOrderDetailViewModel, ActivityShopGroupOrderDetailBinding> {
    ...
    private void bindViewData(OrderDetailResult bean) {
        ...
        mBinding.tvStatusName.setText("团购订单已完成");
...
//        }
        ...
        if (!TextUtils.isEmpty(info.getTerm()) && info.getTerm().contains("-")) {
