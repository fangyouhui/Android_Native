...
public class MockData {
    ...
    public static List<VideoEntity> getVideoData() {
        ...
        video1.setContent("#街坊 #颜值打分 给自己颜值打100分的女生集合");
        ...
        video2.setContent("400 户摊主开进济南环联夜市，你们要的烟火气终于来了！");
        ...
        video3.setContent("科比生涯霸气庆祝动作，最后动作诠释了一生荣耀 #科比 @路人王篮球 ");
        ...
        video4.setContent("美好的一天，从发现美开始 #莉莉柯林斯 ");
        ...
        video5.setContent("有梦就去追吧，我说到做到。 #网球  #网球小威 ");
        ...
        video6.setContent("能力越大，责任越大，英雄可能会迟到，但永远不会缺席  #蜘蛛侠 ");
        ...
        video7.setContent("真的拍不出来你的神颜！现场看大屏帅疯！#陈情令南京演唱会 #王一博 😭");
        ...
        sVideo8.setContent("逆序只是想告诉大家，学了舞蹈的她气质开了挂！");
