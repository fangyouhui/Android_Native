...
package com.pai8.ke.qrcode.zxing.camara;
...
public final class CameraManager {
 ...
 // private static final int MAX_FRAME_HEIGHT = 400;
   ...
   */
	public boolean openDriver(SurfaceHolder holder, int viewWidth,
		...
		System.out.println("--------openDriver--------initialized="+initialized);
		if (!initialized) {
			initialized = true;
   ...
   */
  public synchronized void startPreview(PreviewCallback cb) {
    Camera theCamera = camera;
    if (theCamera != null && !previewing) {
      theCamera.setPreviewCallback(cb);
