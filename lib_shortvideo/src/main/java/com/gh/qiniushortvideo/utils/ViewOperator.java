...
public class ViewOperator {
    ...
    public ViewOperator(RelativeLayout rootView, ViewGroup titleView, View bottomRootView,
        ...
        if (bottomEditorView.isPlayerNeedZoom()) {
            ...
            playerAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                ...
                public void onAnimationUpdate(ValueAnimator animation) {
                    ...
                    int marginTop =
                            (int) Math.abs(mPlayerViewMarginTop - mAnimateMoveLength * (1 - animatedValue) / (1 - SCALE_SIZE));
