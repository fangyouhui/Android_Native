...
import com.gh.qiniushortvideo.adapter.ChooseMusicAdapter;
...
public class ChooseMusicActivity extends AppCompatActivity implements
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mMusicRecyclerView.addItemDecoration(new DividerItemDecoration(getApplicationContext(), DividerItemDecoration.VERTICAL));
