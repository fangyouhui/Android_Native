...
public class VideoPuzzleActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mEncodeSize = new Point(mVideoEncodeSetting.getVideoEncodingWidth(),
                mVideoEncodeSetting.getVideoEncodingHeight());
        initVideoMixItems();
    ...
    private void configVideoEncodeSetting() {
        ...
        mVideoEncodeSetting.setEncodingSizeLevel(RecordSettings.ENCODING_SIZE_LEVEL_ARRAY[14]);
        mVideoEncodeSetting.setEncodingBitrate(RecordSettings.ENCODING_BITRATE_LEVEL_ARRAY[6]);
    ...
    private void configPlayerViews(int previewLayoutWidth, int previewLayoutHeight) {
        ...
        ConstraintLayout.LayoutParams layoutParams =
                (ConstraintLayout.LayoutParams) mPreviewLayout.getLayoutParams();
    ...
    private void initVideoMixItems() {
        ...
        if (mVideoCount == 3) {
            ...
            mVideoMixItem3.setVideoRect(new Rect(mEncodeSize.x / 2, mEncodeSize.y / 3, mEncodeSize.x,
                    mEncodeSize.y));
        ...
        if (mVideoCount == 4) {
            ...
            mVideoMixItem4.setVideoRect(new Rect(mEncodeSize.x / 2, mEncodeSize.y / 2, mEncodeSize.x,
                    mEncodeSize.y));
