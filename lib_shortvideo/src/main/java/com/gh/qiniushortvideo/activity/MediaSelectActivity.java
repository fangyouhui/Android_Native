...
import com.gh.qiniushortvideo.adapter.MediaFileAdapter;
import com.gh.qiniushortvideo.model.MediaFile;
import com.gh.qiniushortvideo.utils.Config;
import com.gh.qiniushortvideo.utils.MediaUtils;
...
public class MediaSelectActivity extends AppCompatActivity implements MediaFileAdapter.OnItemClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mMediaChosenView.setLayoutManager(new LinearLayoutManager(this, LinearLayoutManager.HORIZONTAL,
                false));
    ...
    public void onClickNext(View v) {
        ...
        if (mType == TYPE_VIDEO_MIX) {
            ...
            intent.putParcelableArrayListExtra(VideoPuzzleActivity.VIDEO_LIST,
                    mMediaChosenAdapter.getMediaFiles());
        } else {
            return;
        }
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                if (mMediaFileAdapter == null) {
                                    mMediaFileAdapter = new MediaFileAdapter(MediaSelectActivity.this,
                                            MediaFileAdapter.TYPE_MEDIA_SHOW, mediaFiles);
    ...
    private void composeMediaFiles() {
        ...
        setting.setEncodingSizeLevel(RecordSettings.ENCODING_SIZE_LEVEL_ARRAY[14]);
        setting.setEncodingBitrate(RecordSettings.ENCODING_BITRATE_LEVEL_ARRAY[7]);
