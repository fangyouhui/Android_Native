package com.gh.qiniushortvideo.tusdk;
...
import com.gh.qiniushortvideo.tusdk.playview.TuSdkMovieScrollView;
import com.gh.qiniushortvideo.view.BaseBottomView;
...
public class SpecialEffectBottomView extends BaseBottomView {
    ...
    public interface OnEffectClickedListener {
        // 当按住并选择特效的时候触发
        void onPressSceneEffect(int position, String sceneCode, long startTimeUs,
    ...
    protected void init() {
        ...
        mSceneRecyclerView.setLayoutManager(new LinearLayoutManager(mContext,
        ...
        mSceneAdapter.setOnItemTouchListener(new SceneRecyclerAdapter.OnItemTouchListener() {
            ...
            @Override
            public void onItemTouch(MotionEvent event, final int position,
                                    final SceneRecyclerAdapter.SceneViewHolder sceneViewHolder) {
            ...
            private void onPressSceneEffect(SceneRecyclerAdapter.SceneViewHolder sceneViewHolder,
                                            int position) {
                ...
                if (mOnEffectClickedListener != null) {
                    mOnEffectClickedListener.onPressSceneEffect(position, mSceneCode, mStartTimeUs,
                            sceneViewHolder);
                }
            }
        ...
        mDeleteEffectBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (mOnEffectClickedListener != null) {
