...
import com.gh.qiniushortvideo.tusdk.playview.rangeselect.TuSdkMovieColorGroupView;
import com.gh.qiniushortvideo.tusdk.playview.rangeselect.TuSdkMovieColorRectView;
    ...
    private void init(Context context) {
        ...
        getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                if (!isSetLayoutWidth) {
                    ViewGroup.LayoutParams layoutParams1 = new ViewGroup.LayoutParams(getWidth(),
                            getHeight());
                ...
                if (mType == 1) {
                    TuSdkRangeSelectionBar rangeSelectionBar =
                            (TuSdkRangeSelectionBar) mMovieScrollContentView.getChildAt(2);
                    int barWidth = TuSdkContext.dip2px(15);
                    if (rangeSelectionBar != null) barWidth = rangeSelectionBar.getBarWidth();
                    mMovieScrollContentView.setPadding(getWidth() / 2 - getPaddingLeft() - barWidth, 0,
                            getWidth() / 2 - getPaddingRight() - barWidth, 0);
                    isInit.getAndAdd(-1);
                } else {
                    mMovieScrollContentView.setPadding(getWidth() / 2 - getPaddingLeft(), 0,
                            getWidth() / 2 - getPaddingRight(), 0);
                    isInit.getAndAdd(-1);
                }
            }
        });
