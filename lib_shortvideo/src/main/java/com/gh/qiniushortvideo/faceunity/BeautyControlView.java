package com.gh.qiniushortvideo.faceunity;
...
import static com.gh.qiniushortvideo.faceunity.BeautyParameterModel.STR_FILTER_LEVEL;
import static com.gh.qiniushortvideo.faceunity.BeautyParameterModel.getValue;
import static com.gh.qiniushortvideo.faceunity.BeautyParameterModel.isHeightPerformance;
import static com.gh.qiniushortvideo.faceunity.BeautyParameterModel.isOpen;
import static com.gh.qiniushortvideo.faceunity.BeautyParameterModel.sFilterLevel;
import static com.gh.qiniushortvideo.faceunity.BeautyParameterModel.sFilterName;
import static com.gh.qiniushortvideo.faceunity.BeautyParameterModel.sHairLevel;
import static com.gh.qiniushortvideo.faceunity.BeautyParameterModel.sHeavyBlur;
import static com.gh.qiniushortvideo.faceunity.BeautyParameterModel.sSkinDetect;
import static com.gh.qiniushortvideo.faceunity.BeautyParameterModel.setValue;
...
public class BeautyControlView extends FrameLayout {
    ...
    private static final List<Integer> FACE_SHAPE_ID_LIST = Arrays.asList(R.id.face_shape_0_nvshen,
            R.id.face_shape_1_wanghong, R.id.face_shape_2_ziran, R.id.face_shape_3_default,
            R.id.face_shape_4);
    ...
    private void initMakeupView() {
        ...
        mRvMakeupItems.addItemDecoration(new VHSpaceItemDecoration(0,
    ...
    private void initAnimojiView() {
        ...
        AnimojiAdapter animojiAdapter =
                new AnimojiAdapter(EffectEnum.getEffectsByEffectType(Effect.EFFECT_TYPE_ANIMOJI));
    ...
    private void initCartoonView() {
        ...
        CartoonFilterAdapter cartoonFilterAdapter =
                new CartoonFilterAdapter(CartoonFilterEnum.getAllCartoonFilters());
    ...
    private void initHairView() {
        ...
        ArrayList<Effect> hairGradientEffects =
                EffectEnum.getEffectsByEffectType(Effect.EFFECT_TYPE_HAIR_GRADIENT);
    ...
    private void initGesture() {
        ...
        EffectRecyclerAdapter gestureAdapter = new EffectRecyclerAdapter(mContext,
    ...
    private void initNormalEffect() {
        ...
        EffectRecyclerAdapter normalEffectAdapter = new EffectRecyclerAdapter(mContext,
    ...
    private void initExpression() {
        ...
        EffectRecyclerAdapter expressionAdapter = new EffectRecyclerAdapter(mContext,
    ...
    private void initHahaMirror() {
        ...
        EffectRecyclerAdapter hahaMirrorAdapter = new EffectRecyclerAdapter(mContext,
    ...
    private void initFaceChange() {
        ...
        EffectRecyclerAdapter faceChangeAdapter = new EffectRecyclerAdapter(mContext,
    ...
    private void initBackground() {
        ...
        EffectRecyclerAdapter backgroundAdapter = new EffectRecyclerAdapter(mContext,
    ...
    private void initPortraitDrive() {
        ...
        EffectRecyclerAdapter portraitDriveAdapter = new EffectRecyclerAdapter(mContext,
...
//        mStickerOptionItems.add(new StickerOptionItem(mContext.getResources().getString(R.string.beauty_radio_beauty)));
        ...
        mRvStickerOption.setLayoutManager(new LinearLayoutManager(mContext, LinearLayoutManager.HORIZONTAL,
                false));
    ...
    private void initViewSkinBeauty() {
        ...
        mBoxSkinDetect.setOnOpenChangeListener(new BeautyBox.OnOpenChangeListener() {
            ...
            public void onOpenChanged(BeautyBox beautyBox, boolean isOpen) {
                ...
                setDescriptionShowStr(sSkinDetect == 0 ? R.string.beauty_box_skin_detect_close :
                        R.string.beauty_box_skin_detect_open);
                onChangeFaceBeautyLevel(R.id.beauty_box_skin_detect);
            }
        });
        ...
        mBoxHeavyBlur.setOnDoubleChangeListener(new BeautyBox.OnDoubleChangeListener() {
            ...
            public void onDoubleChanged(BeautyBox beautyBox, boolean isDouble) {
                ...
                setDescriptionShowStr(sHeavyBlur == 0 ? R.string.beauty_box_heavy_blur_normal_text :
                        R.string.beauty_box_heavy_blur_double_text);
        ...
        mFaceShapeCheckedLine.post(new Runnable() {
            ...
            public void run() {
                ...
                RelativeLayout.LayoutParams params =
                        (RelativeLayout.LayoutParams) mFaceShapeCheckedLine.getLayoutParams();
                int textWidth = radioButton == null || radioButton.getVisibility() == GONE ? 0 :
                        (int) radioButton.getPaint().measureText(radioButton.getText().toString());
                params.width = textWidth;
                params.leftMargin = radioButton == null || radioButton.getVisibility() == GONE ? 0 :
                        (radioButton.getLeft() + (radioButton.getWidth() - textWidth) / 2);
                ...
                if (currentPos == 0) {
                    ...
                    if (makeupItems != null) {
                        for (MakeupItem makeupItem : makeupItems) {
                            float lev =
                                    makeupItem.getDefaultLevel() * level / FaceMakeupEnum.MAKEUP_OVERALL_LEVEL.get(faceMakeup.getNameId());
                    ...
                    if (mHairAdapter.mPositionSelect <= mHairGradientCount) {
                        ...
                        mOnFUControlListener.onHairLevelSelected(FURenderer.HAIR_GRADIENT, hairIndex,
                                hairIndex < 0 ? 0 : (sHairLevel[mHairAdapter.mPositionSelect - 1] =
                                        1.0f * value / 100));
                    } else {
        ...
        mBottomLayoutAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                if (mOnBottomAnimatorChangeListener != null) {
                    ...
                    mOnBottomAnimatorChangeListener.onBottomAnimatorChangeListener(startHeight > endHeight
                            ? 1 - showRate : showRate);
                }
            }
        });
    ...
    private class OnFaceMakeupClickListener implements BaseRecyclerAdapter.OnItemClickListener<FaceMakeup> {
        ...
        public void onItemClick(BaseRecyclerAdapter<FaceMakeup> adapter, View view, int position) {
            ...
            if (position == 0) {
                ...
                Pair<Filter, Float> filterFloatPair =
                        FaceMakeupEnum.MAKEUP_FILTERS.get(faceMakeup.getNameId());
                    ...
                    if (mOnFUControlListener != null) {
                        if (mPositionSelect == 0) {
                            if (lastPos <= mHairGradientCount) {
                                mOnFUControlListener.onHairSelected(FURenderer.HAIR_GRADIENT, hairIndex,
                                        0.0f);
                            } else {
                            ...
                            if (mPositionSelect <= mHairGradientCount) {
                                ...
                                mOnFUControlListener.onHairSelected(FURenderer.HAIR_NORMAL, hairIndex,
                                        hairLevel);
                            }
                        }
                    }
     ...
     * 特效选择监听器
     */
    private EffectRecyclerAdapter.OnEffectSelectListener mOnEffectSelectListener =
            new EffectRecyclerAdapter.OnEffectSelectListener() {
                @Override
