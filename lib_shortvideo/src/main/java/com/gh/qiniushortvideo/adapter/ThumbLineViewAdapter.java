package com.gh.qiniushortvideo.adapter;
    ...
    public ThumbnailViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            ...
            case VIEW_TYPE_FOOTER:
                ...
                view.setLayoutParams(new ViewGroup.LayoutParams(mThumbLineViewSettings.getScreenWidth() / 2
                        , ViewGroup.LayoutParams.MATCH_PARENT));
                view.setBackgroundColor(Color.TRANSPARENT);
                return new ThumbnailViewHolder(view);
            default:
                view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_thumbnail_view,
                        parent, false);
                return new ThumbnailViewHolder(view);
        }
    }
