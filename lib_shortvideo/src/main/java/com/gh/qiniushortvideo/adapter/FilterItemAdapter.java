...
public class FilterItemAdapter extends RecyclerView.Adapter<FilterItemAdapter.FilterItemViewHolder> {
    ...
    public FilterItemAdapter(Context context, List<PLBuiltinFilter> filters,
    ...
    private void setFilter(int index) {
        ...
        if (mOnFilterSelectListener != null) {
            if (mCurrentPosition == 0) {
                ...
                mOnFilterSelectListener.onFilterSelected(filter.getName(),
                        mFilterDescriptions.get(mCurrentPosition - 1));
            }
        }
        ...
        try {
            ...
            holder.mIcon.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (mOnFilterSelectListener != null) {
                        mOnFilterSelectListener.onFilterSelected(filter.getName(),
                                mFilterDescriptions.get(position - 1));
                    }
                }
            });
        } catch (IOException e) {
