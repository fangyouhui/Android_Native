...
public class RangeSlider extends ViewGroup {
    ...
    public RangeSlider(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mLeftThumb = new ThumbView(context, mThumbWidth, lDrawable == null ?
                new ColorDrawable(getResources().getColor(R.color.colorAccent)) : lDrawable);
        mRightThumb = new ThumbView(context, mThumbWidth, rDrawable == null ?
                new ColorDrawable(getResources().getColor(R.color.colorAccent)) : rDrawable);
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (mLeftThumb.isPressed()) {
                    ...
                    handle = true;
                    if (mRangeChangeListener != null) {
                        mRangeChangeListener.onKeyUp(TYPE_LEFT, mLeftThumb.getRangeIndex(),
    ...
    private void notifyRangeChange(int type) {
        if (mRangeChangeListener != null) {
//            mRangeChangeListener.onRangeChange(this, type, mLeftThumb.getRangeIndex(), mRightThumb
//            .getRangeIndex());
        }
    }
