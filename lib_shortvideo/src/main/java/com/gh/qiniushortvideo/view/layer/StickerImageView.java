...
import com.gh.qiniushortvideo.gif.GifDecoder;
import com.gh.qiniushortvideo.gif.GifFrameLoader;
...
public class StickerImageView extends AppCompatImageView {
    ...
    private void obtainStyledAttributes(AttributeSet attrs) {
        ...
        mFramePadding = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, DEFAULT_FRAME_PADDING,
                mDisplayMetrics);
        mFrameWidth = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, DEFAULT_FRAME_WIDTH,
                mDisplayMetrics);
    ...
    private void transformDraw() {
        ...
        computeRect(-mFramePadding, -mFramePadding, bitmapWidth + mFramePadding,
                bitmapHeight + mFramePadding, mDegree);
        ...
        //设置画该图片的起始点
        mTransformMatrix.postTranslate(mOffsetX + mControlDrawableWidth / 2,
                mOffsetY + mControlDrawableHeight / 2);
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (mStatus == STATUS_ROTATE_ZOOM) {
                    ...
                    float bitmapToCenterDistance =
                            (float) Math.sqrt(halfBitmapWidth * halfBitmapWidth + halfBitmapHeight * halfBitmapHeight);
                    ...
                    PointF centerToPreMove = new PointF((mPreMovePointF.x - mCenterPoint.x),
                    ...
                    float result =
                            centerToPreMove.x * centerToCurMove.y - centerToPreMove.y * centerToCurMove.x;
    ...
    private void computeRect(int left, int top, int right, int bottom, float degree) {
        ...
        // View 中心点的坐标
        Point viewCenterPoint = new Point((maxCoordinateX + minCoordinateX) / 2,
