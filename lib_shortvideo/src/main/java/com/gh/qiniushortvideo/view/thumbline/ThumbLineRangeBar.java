...
public class ThumbLineRangeBar {
    ...
    public ThumbLineRangeBar(ThumbLineView thumbLineView, long startTime, long duration, long minDurationMs
            , long maxDurationMs, ThumbLineRangeBarView thumbLineRangeBarView,
                             OnSelectedDurationChangeListener listener) {
    ...
    public void requestLayout() {
        ViewGroup.MarginLayoutParams layoutParams =
                (ViewGroup.MarginLayoutParams) mHeadView.getView().getLayoutParams();
        int margin;
