package com.gh.qiniushortvideo.view.thumbline;
...
import com.gh.qiniushortvideo.adapter.ThumbLineViewAdapter;
import com.gh.qiniushortvideo.utils.ThumbLineViewSettings;
...
import static com.gh.qiniushortvideo.view.thumbline.ThumbLineRangeBar.STATE_ACTIVE;
import static com.gh.qiniushortvideo.view.thumbline.ThumbLineRangeBar.STATE_FIX;
...
public class ThumbLineView extends FrameLayout {
    ...
    public float getThumbLineViewWidth() {
        if (mThumbLineViewWidth == 0) {
            mThumbLineViewWidth =
                    mThumbLineViewSettings.getThumbnailCount() * mThumbLineViewSettings.getThumbnailWidth();
        }
     ...
     */
    public void addOverlayView(final View overlayView, final ThumbLineHandleView headView,
                               final ThumbLineRangeBar overlay) {
        addView(overlayView);
    ...
    public ThumbLineRangeBar addOverlayRangeBar(long startTime, long duration,
                                                ThumbLineRangeBar.ThumbLineRangeBarView view,
                                                long minDuration,
                                                ThumbLineRangeBar.OnSelectedDurationChangeListener listener) {
        if (startTime < 0) {
            startTime = 0;
        }
        ...
        ThumbLineRangeBar rangeBar = new ThumbLineRangeBar(this, startTime, duration, minDuration,
                mThumbLineViewSettings.getVideoDuration(), view, listener);
    ...
    private void initView() {
        ...
        mThumbRecyclerView.setLayoutManager(new LinearLayoutManager(getContext(),
                LinearLayoutManager.HORIZONTAL, false));

        // 初始化指示器
        View indicator = new View(getContext());
        int indicatorWidth = Utils.dip2px(getContext(), 2);
        LayoutParams params = new LayoutParams(indicatorWidth, ViewGroup.LayoutParams.WRAP_CONTENT,
                Gravity.CENTER);
