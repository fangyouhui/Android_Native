...
import com.gh.qiniushortvideo.view.thumbline.ThumbLineView;
...
public class MusicSelectBottomView extends BaseBottomView {
    ...
    public void addMusicBar(long startTime, long duration) {
        ...
        ThumbLineRangeBar thumbLineRangeBar = new ThumbLineRangeBar(mVideoThumbLineView, startTime,
                duration, 0, mMediaFile.getDurationMs(), thumbLineRangeBarView, null);
    ...
    protected void init() {
        ...
        mSelectedMusicRv.setLayoutManager(new LinearLayoutManager(mContext, LinearLayoutManager.VERTICAL,
                false));
        ...
        musicAddBtn.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    class SelectedMusicAdapter extends RecyclerView.Adapter<SelectedMusicViewHolder> {
        ...
        public SelectedMusicViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_selected_music,
                    parent, false);
