...
import com.gh.qiniushortvideo.adapter.GifStickerAdapter;
import com.gh.qiniushortvideo.view.layer.OnStickerOperateListener;
import com.gh.qiniushortvideo.view.layer.StickerImageView;
import com.gh.qiniushortvideo.view.thumbline.ThumbLineRangeBar;
...
public class GifBottomView extends StickerBottomView {
    ...
    protected void init() {
        ...
        mStickerRecyclerView.setLayoutManager(new LinearLayoutManager(mContext,
                LinearLayoutManager.HORIZONTAL, false));
        mGifStickerAdapter = new GifStickerAdapter(mContext,
                new ArrayList<>(Arrays.asList(getResources().getStringArray(R.array.gif_name))));
        mGifStickerAdapter.setOnGifStickerClickListener(new GifStickerAdapter.OnGifStickerClickListener() {
            ...
            public void onGifClicked(final String filePath) {
                ...
                // 点击具体动图时，添加到滑动条上
                ThumbLineRangeBar.ThumbLineRangeBarView thumbLineRangeBarView =
                        new ThumbLineRangeBar.ThumbLineRangeBarView() {
                            View rootView = LayoutInflater.from(mContext).inflate(R.layout.widget_range_bar
                                    , null);
                ...
                final StickerImageView stickerImage = (StickerImageView) View.inflate(mContext,
                        R.layout.sticker_image_view, null);
                ...
                ThumbLineRangeBar thumbLineRangeBar = new ThumbLineRangeBar(mVideoThumbLineView,
                        mCurrentPosition, 2000, 2000, mMediaFile.getDurationMs(), thumbLineRangeBarView,
                        new ThumbLineRangeBar.OnSelectedDurationChangeListener() {
                            @Override
