        ...
        public ItemViewHolder(View itemView) {
            ...
            mText.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    final StickerTextView textView = (StickerTextView) View.inflate(mContext,
                            R.layout.sticker_text_view, null);
                    textView.setTypeface(mText.getTypeface());
                    textView.setTextColor(mText.getCurrentTextColor());
                    textView.setShadowLayer(mText.getShadowRadius(), mText.getShadowDx(),
                            mText.getShadowDy(), mText.getShadowColor());
    ...
    private class TextEffectListAdapter extends RecyclerView.Adapter<ItemViewHolder> {
        ...
        public void onBindViewHolder(final ItemViewHolder holder, int position) {
            ...
            if (info.shadowRadius > 0) {
                holder.mText.setShadowLayer(info.shadowRadius, info.shadowDx, info.shadowDy,
                        info.shadowColor);
            }
        }
